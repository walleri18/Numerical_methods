...
void SolutionEquation::SimpleIterationMethod(Function newOurFunction, Function firstDerivativeNewOurFunction, double argument)
{
	...
	{
		std::cout << std::endl << std::endl << "Метод просты итераций на данном отрезке [" << beginSegment << "; " 
			<< endSegment << "] не сходиться." << std::endl << "Найти корень на данном отрезке для данного уравнения этим методом не представляется возможным."
...
void SolutionEquation::HalfDivisionMethod(Function ourFunction)
{
	...
	{
		std::cout << std::endl << std::endl << "Метод Деления на данном отрезке [" << beginSegment << "; " 
			<< endSegment << "] не сходиться." << std::endl << "Найти корень на данном отрезке для данного уравнения этим методом не представляется возможным.";
